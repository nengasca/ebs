 ...
 */
public class BillsReceipt extends javax.swing.JFrame {

    /**
     * Creates new form BillsReceipt
     */
    public BillsReceipt() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillsReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillsReceipt().setVisible(true);
            }
        });
    }
